"""
Artery Risk Analysis - Shared Model Architectures

This module contains all neural network architectures used across
training, inference, and the backend API.
"""
...
class ChamferDistanceLoss(nn.Module):
    ...
    Permutation-invariant loss that finds nearest neighbors between two point sets.
    """
